<<nav class="navbar-collapse">
	<div class="" role="tabpanel" data-example-id="togglable-tabs">
      <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
        ...
        <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Meeting</a>
        </li>
    
        <li role="presentation" class=""><a href="#tab_content3" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Anggota</a>
        </li>
      </ul>
    </div>
    </nav>
...
<nav class="navbar-collapse" role="tabpanel" data-example-id="togglable-tabs">
   <ul id="myTab" class="nav navbar-nav nav-tabs bar_tabs" role="tablist">
	...
	<li role="presentation" class="active"><a href="<?=base_url('Divisi/Meeting')?>" role="tab" id="meeting" data-toggle="tab" aria-expanded="false">Meeting</a>
	</li>
	<li role="presentation" class="active"><a href="<?=base_url('Divisi/anggotadivisi')?>" role="tab" id="anggota" data-toggle="tab" aria-expanded="false">Anggota</a>
	</li>
   </ul>
</nav>
-->